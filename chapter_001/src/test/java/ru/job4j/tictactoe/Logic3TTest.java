...
public class Logic3TTest {
    ...
    @Test
    public void whenHasXWinner6By6() {
        Figure3T[][] table = {
                {new Figure3T(true), new Figure3T(), new Figure3T(), new Figure3T(), new Figure3T(), new Figure3T()},
                {new Figure3T(), new Figure3T(true), new Figure3T(), new Figure3T(), new Figure3T(), new Figure3T()},
                {new Figure3T(), new Figure3T(), new Figure3T(true), new Figure3T(), new Figure3T(), new Figure3T()},
                {new Figure3T(), new Figure3T(), new Figure3T(), new Figure3T(true), new Figure3T(), new Figure3T()},
                {new Figure3T(), new Figure3T(), new Figure3T(), new Figure3T(), new Figure3T(true), new Figure3T()},
                {new Figure3T(), new Figure3T(), new Figure3T(), new Figure3T(), new Figure3T(), new Figure3T(true)},
        };
        Logic3T login = new Logic3T(table);
        assertThat(login.isWinnerX(), is(true));
    }
